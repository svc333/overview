...
- 它必須確認如何符合「最大可容忍運作中斷時間」，並且必須儲存在「災難回復計劃儲存庫」資料庫中。  
...
|多倫多 01|tor01|
|墨西哥 01|mex01|
{: caption="表 2. 北美洲的資料中心" caption-side="top"}
...
|----------|---------|
|聖保羅 01|sao01|
{: caption="表 3. 南美洲的資料中心" caption-side="top"}
...
|巴黎 01|par01|
|奧斯陸 01|osl01|
{: caption="表 4. 歐洲的資料中心" caption-side="top"}
...
|雪梨 05|syd05|
|墨爾本 01|mel01|
{: caption="表 5. 亞太地區的資料中心" caption-side="top"}
...
|<99.95% |<99.5% |10% |
|<99.90% |<99.0% |25% |
{: caption="表 6. 每月可用性服務水準" caption-side="top"}
