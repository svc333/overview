...
每个开发者仪表板都提供与仪表板的焦点区域相关的初学者工具包，还提供一致的直观工作流程。通过该工作流程，您可以在几分钟内创建出一个可用于生产环境的有效应用程序。
...
通过 {{site.data.keyword.cloud_notm}} 入门模板工具包创建应用程序时，应用程序首先采用成熟的体系结构，该体系结构也反映了所选语言的最佳实践。
