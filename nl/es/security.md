...
{{site.data.keyword.cloud_notm}} público y dedicado utiliza los servicios de nube de infraestructura como servicio (IaaS) clásica y aprovecha su arquitectura de seguridad. IaaS clásica proporciona varias capas de protección solapadas para sus aplicaciones y datos. En {{site.data.keyword.cloud_notm}} local, usted es el propietario de la seguridad física y proporciona
...
## Cumplimiento con {{site.data.keyword.Bluemix_notm}}
{: #compliance}
...
{{site.data.keyword.Bluemix}} completa un asesoramiento de PCI DSS anual utilizando un Qualified Security Assessor (QSA) aprobado. Para obtener información sobre la ayuda en el cumplimiento con PCI DSS para su entorno {{site.data.keyword.Bluemix_notm}}, póngase en contacto con el equipo de ventas en [Póngase en contacto con nosotros ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](https://cloud.ibm.com/?direct=classic/#/contactUs/cloudOEPaneId=contactUs){: new_window}.
...
Puede haber cuestiones derivadas de la fusión de {{site.data.keyword.Bluemix_notm}} Público con la infraestructura clásica. Para obtener más información o asistencia para conseguir, certificar y mantener la conformidad de HIPAA para su entorno de {{site.data.keyword.Bluemix_notm}}, póngase en contacto con el equipo de [ventas ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](mailto:cloudplatform_compliance@us.ibm.com){:new_window} de {{site.data.keyword.Bluemix_notm}}.
