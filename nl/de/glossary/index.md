...
Ein persistentes Speichersystem in der IBM Cloudumgebung, in dem Benutzer Dateien speichern und freigeben. Benutzer können in {{site.data.keyword.containerlong}} Docker-Datenträger für die Dateifreigabe anhängen.
...
Eine Position in einem Bereich, in dem {{site.data.keyword.containerlong}} ausgeführt wird. 
