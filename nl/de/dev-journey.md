...
Mit der {{site.data.keyword.cloud_notm}} können Sie Folgendes tun:
...
* Sie können die [Befehlszeilenschnittstelle](/docs/cli/index.html#overview) (Command Line Interface, CLI) für die lokale Entwicklung verwenden.
