...
Für einige Ressourcen ist keine Region erforderlich, da sie als global betrachtet werden können. In diesem Fall wird das Segment `region` auf `global` gesetzt.
{: tip}
