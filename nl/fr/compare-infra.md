...
Pour connaître les différences en matière de calcul entre l'infrastructure classique et l'infrastructure VPC, reportez-vous au tableau ci-après. Les divers facteurs clé de différentiation sont répertoriés dans la colonne Catégorie, et les descriptions sont répertoriées dans les colonnes Infrastructure classique et Infrastructure VPC.  
...
Pour connaître les différences en matière de réseau entre l'infrastructure classique et l'infrastructure VPC, reportez-vous au tableau ci-après. Les divers facteurs clé de différentiation sont répertoriés dans la colonne Catégorie, et les descriptions sont répertoriées dans les colonnes Infrastructure classique et Infrastructure VPC.  
