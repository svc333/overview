...
La plateforme Cloud Computing innovante d'{{site.data.keyword.IBM_notm}} combine une plateforme sous forme de services (PaaS) à une infrastructure sous forme de services et inclut un catalogue de services de cloud pouvant être intégré à la plateforme sous forme de services et à l'infrastructure sous forme de services afin de générer des applications métier.
{:shortdesc}
...
* De déployer une infrastructure de calcul et de stockage dont les performances sont élevées dans des {{site.data.keyword.CloudDataCents_notm}} sécurisés au niveau mondial.
