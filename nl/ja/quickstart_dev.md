...
* 特定のソリューション用のすぐに使用可能な[コード・パターン](https://developer.ibm.com/patterns/){: new_window} ![外部リンク・アイコン](../icons/launch-glyph.svg "外部リンク・アイコン") をダウンロードして、プロセスを直ちに開始します。 詳しくは、『[コード・パターンを使用したアプリの作成](/docs/apps/tutorials/tutorial_code-pattern.html)』を参照してください。
