...
スターター・キットにより、製品やサービスが、使用しやすくカスタマイズしやすいものになります。スターター・キットは、開発者が選択した言語で、クラウド・デプロイメントの準備が完了したスケルトン実動アプリをアセンブルします。 各スターター・キットには、特定のユース・ケース用およびコードの再利用のための言語、フレームワーク、およびパターンが含まれています。
...
* **サンプル**は、特定のフィーチャー、機能、サービス、またはユーザー・ジャーニーの小さな例です。 サンプルを再利用したり、実動アプリケーションに組み込んだりすることができます。通常、技術的な機能および技術的な問題を解決するためのアプローチの候補を示すために使用します。
