...
### マルチゾーン地域 (MZR) (multi-zone region (MZR))
{: #x9766831}

2 つ以上のゾーンで構成される地域で、独立した電気、機械、およびネットワーク・インフラストラクチャーを持つ 1 つ以上の論理的に隔離されたデータ・センターの複数のグループ。

### MZR
{: #x9766835}

[「マルチゾーン・リージョン (multi-zone region)」](#x9766831)を参照。
