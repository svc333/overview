...
米国は、対外政策や国家安全保障上の理由から、少数の国に対して、ほとんどの商取引やその他の取引を禁止しています。これらの禁止事項は、正式に貿易と経済制裁または包括的な禁輸措置として知られており、現在、イラン、キューバ、北朝鮮、シリアを対象としています。 

IBM Cloud は、これらの貿易および経済制裁の対象となる国から発信される IP アドレスへの通信のネットワーク全体のブロックを実装しています。このポリシーは、すべての IBM Cloud データ・センターの場所および環境に影響を及ぼし、米国の貿易および経済制裁の対象となる国に登録された IP アドレスによるアクセスをブロックします。

米国の禁輸国に関連付けられた IP アドレスを識別するために、IBM Cloud は、[MaxMind ![外部リンク・アイコン](../../icons/launch-glyph.svg)](http://www.maxmind.com){: new_window} によって管理される Geo IP2 Database を参照します。IBM Cloud は、IP アドレスの国別マッピングを四半期ごとに更新します。

注: この制限は、米国の制裁および禁輸措置の下で禁止されていないコンテンツには適用されません。お客様のコンテンツが米国の貿易と経済制裁の下で禁止されていないと信じる場合は、exemptions@softlayer.com まで E メールを送信してください。 
