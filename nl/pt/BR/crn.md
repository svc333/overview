...
Alguns recursos não requerem uma região, pois podem ser considerados `global`. Nesse caso, o segmento `region` é configurado para `global`.
{: tip}
...
{: caption="Tabela 2. Uso do escopo" caption-side="top"}
