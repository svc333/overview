...
{{site.data.keyword.IBM_notm}}, Watson e muito mais. Além dos próprios recursos da plataforma, o {{site.data.keyword.cloud}} também fornece implementação flexível. Forneça recursos do {{site.data.keyword.cloud}} no local, em ambientes dedicados de nuvem particular ou na nuvem pública e gerencie os recursos de todos os três tipos de ambientes em um único painel.
