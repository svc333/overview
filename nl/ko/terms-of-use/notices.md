...
고객에게 지정된 IP 주소는 IBM Corporation 또는 그 자회사들(IBM)의 소유이며 본 클라우드 서비스에만 사용되도록 되어 있습니다. 해당 IP 주소들의 사용은 서비스가 만료되거나 종료되면 종료되며, 해당 IP 주소들은 이후 회수되어 추후 다른 고객에게 다시 제공될 수 있습니다. 
...
초기 검토에 최대 2 영업일이 소요될 수 있으며, 규모와 복잡도에 따라 완료까지 추가로 시간이 소요될 수 있습니다. Abuse 티켓이 공개된 계정은 abuse 사례가 모두 해결될 때까지 IP 요청의 처리가 보류됩니다. 
...
미국은 외교 정책 및 국가 안전 보장의 이유로 일부 국가들과의 상거래 및 기타 거래 대부분을 제한하고 있습니다.  공식적으로 무역 및 경제 제제 또는 수출금지 및 거래에 대한 포괄적 엠바고로 알려진 이러한 금지는 현재 이란, 쿠바, 북한 및 시리아를 대상으로 합니다. 

IBM Cloud에서는 거래 및 경제 제제 대상인 국가들에 있는 IP 주소들과의 통신을 네트워크 차원에서 차단합니다. 이 정책은 모든 IBM Cloud 데이터 센터 위치 및 환경을 대상으로 하며, 미국의 무역 및 경제 제제 대상인 국가에서 등록된 IP 주소들로의 액세스를 차단합니다.
