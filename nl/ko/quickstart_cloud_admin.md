...
환경을 계획, 프로비저닝 및 관리하는 다양한 도구에 대한 링크를 제공하는 {{site.data.keyword.cloud_notm}}의 [IT 운영 관리자 과정 탐색](/docs/overview/it-ops-journey.html)을 참조하십시오.
{: tip}
...
1. 학습 자료를 활용하여 {{site.data.keyword.cloud_notm}}의 작동 방법을 이해하십시오.
    * {{site.data.keyword.cloud}}에서 [애플리케이션을 호스팅](/docs/overview/ibm-cloud-platform.html#choose-compute)하는 데 사용 가능한 옵션에 대해 알아보십시오.
...
[인프라를 관리](/docs/overview/it-ops-journey.html)하십시오. 일부 예제 관리 태스크는 다음과 같습니다. 
