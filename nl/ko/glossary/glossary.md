...
### 다중 구역 지역(MZR, multi-zone region)
{: #x9766831}

두 개 이상의 구역으로 구성된 지역으로서, 개별 전자, 기계 및 네트워크 인프라가 있는 논리적으로 격리된 하나 이상의 데이터 센터로 구성된 여러 그룹입니다.
...
[다중 구역 지역((MZR, multi-zone region)](#x9766831)을 참조하십시오.
