...
{{site.data.keyword.cloud_notm}} 카탈로그의 모든 사용자가 볼 수 있는 항목입니다. 공용 리소스는 임의 제공자(IBM 또는 서드파티 제공자)가 빌드할 수 있습니다. [개인용 리소스(private resource)](#x9439035)도 참조하십시오.

### 구역(zone)
{: #x2070723}

독립 결함 도메인입니다. 구역은 결함 허용을 개선하고 대기 시간을 감소시키는 데 도움이 되도록 디자인된 추상입니다.
