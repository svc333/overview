...
CRN(Cloud Resource Name)은 {{site.data.keyword.Bluemix_notm}} 리소스를 고유하게 식별합니다. CRN을 사용하면 클라우드 카탈로그에 나열된 {{site.data.keyword.Bluemix_notm}} IAM(Identity and Access Management) 정책 및 서비스에서와 같이 명료하고 글로벌한 고유성이 보장된 방식으로 리소스를 지정할 수 있습니다. 
...
리소스가 상주하는 클라우드 지형/지역/구역/데이터 센터입니다. 
...
`account id`는 IBM 계정 id({{site.data.keyword.Bluemix_notm}} 및 Softlayer 연결 계정)여야 합니다. 
...
`service-instance`는 영숫자, 소문자여야 하며 공백 또는 '-' 및 '/' 이외의 특수 문자는 사용될 수 없습니다. 
...
| 예| 값|
| --- | --- |
| 컨테이너 | `crn:v1:bluemix:public:containers-kubernetes:us-south:a/59bcbfa6ea2f006b4ed7094c1a08dcdd:8042b2a8af6a4a5cbf6dbe09e07311d2:worker:kube-hou02-pa8042b2a8af6a4a5cbf6dbe09e07311d2-w1:`|
