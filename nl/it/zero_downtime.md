...
- Deve confermare come è stato raggiunto il tempo di inattività tollerabile massimo e deve essere memorizzato nel database del repository del piano di ripristino di emergenza.  
...
Per ulteriori informazioni sugli ambienti dedicati, consulta [IBM Cloud dedicato](/docs/dedicated/index.html#dedicated) e per gli ambienti locali, fai clic su [Bluemix locale](/docs/local/index.html#local). 
