...
![Cloud service models.](images/IBM-Cloud-Platform.svg "Diagram showiing the cloud service models"){: caption="Figure 1. Cloud service models" caption-side="bottom"}
